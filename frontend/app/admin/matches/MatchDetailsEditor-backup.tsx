  ...
  return (
    <div className="space-y-4"> 
        {matchId === 0 ? (
            ...
            <p>Debug: divisions count: {divisions.length}, sport: {JSON.stringify(sport)}</p>
            <p>Debug: MatchId: {matchId}</p>
        {divisions.map((d, i) => (
        ...
        >
            ...
            <p>Match details can only be edited when creating a new match. Please save the match first.</p>
        )}
    </div>
  );
};
