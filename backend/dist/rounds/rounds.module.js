...
const round_auto_update_service_1 = require("./round-auto-update.service");
...
exports.RoundsModule = RoundsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [rounds_service_1.RoundsService, round_auto_update_service_1.RoundAutoUpdateService],
        exports: [rounds_service_1.RoundsService, round_auto_update_service_1.RoundAutoUpdateService],
    })
], RoundsModule);
