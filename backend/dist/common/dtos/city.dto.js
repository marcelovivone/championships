...
__decorate([
    (0, swagger_2.ApiProperty)({ example: 'Barcelona', description: 'Name of the city' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateCityDto.prototype, "name", void 0);
__decorate([
    (0, swagger_2.ApiProperty)({ example: 1, description: 'ID of the country' }),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], CreateCityDto.prototype, "countryId", void 0);
class UpdateCityDto extends (0, swagger_1.PartialType)(CreateCityDto) {
}
exports.UpdateCityDto = UpdateCityDto;
class CityResponseDto extends CreateCityDto {
}
